        ...
        <div class="navlist">
            <div class="navlist_top">
                <div v-for="(item,key) in list" v-bind:key="key">
                    <ul v-if="item.valueField!=='zd_xinxi'&&item.valueField!=='zd_fenzhan'&&item.valueField!=='zd_mianji'&&item.valueField!=='zd_buy_changfang'">
                    ...
                    <ul v-if="item.valueField=='zd_mianji'">
                     ...
                     <ul v-if="item.valueField=='zd_buy_changfang'">
                        <li class="title">{{item.valueName}}</li>
            ...
            <div class="navlist_bot">
                ...
                <div class="infolist" v-for="(item,index) in infolist" v-bind:key="index">
                    ...
                    <ul class="money" style="width:260px;text-align: center"><span>{{item.price }}</span>万元</ul></router-link>
                </div>
                <el-pagination
                    background
