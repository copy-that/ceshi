  ...
  <div class="page">
    ...
    <div class="fabu_page" style="padding-bottom:50px;">
      <div class="fabu_page_top">
        <p>
          <router-link :to="{ name: 'fabu'}">选择类型 ></router-link>出租住宅信息
        </p>
      </div>
      ...
      <ul class="fabu_list">
        <li class="name">房&emsp;&emsp;型：</li>
        <li class="input">
          <el-select v-model="fxvalue" placeholder="请选择房型" @change="fxinput">
            <el-option
      ...
      <ul class="fabu_up">
        <li class="upbtn">
          ...
          <input ref="images" @click="uploadimg" type="file">
        </li>
...
export default {
  ...
  data() {
    return {
      ...
      phone:'',//电话
      locationText:'',//地址位置
      latitude:'113.0270',//纬度
      longitude:'45.6500',//经度
      form:'',//装修类型(传id)
      classify:'',//户型
      identity: 0,//身份
      zjmoney:'',//中介费
  ...
  methods: {
    ...
    submitbtn(){
      ...
      var houseAllocation=this.fwpzId.join(',')
      ...
      this.$http("/app/rendInfoApi/saveRendHouse","post",form,this.$store.state.token).then(res => {
