  ...
  <div class="page">
    ...
    <div class="fabu_page" style="padding-bottom:50px;">
      <div class="fabu_page_top">
        <p>
          <router-link :to="{ name: 'fabu'}">选择类型 ></router-link>发布新楼盘信息
        </p>
      </div>
...
export default {
  ...
  methods: {
    ...
    submitbtn(){
      ...
      form.append('dicorationNum',this.dicorationNum)
      ...
      this.$http("/app/rendInfoApi/saveBuyHouse","post",form,this.$store.state.token).then(res => {
