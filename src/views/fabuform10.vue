  ...
  <div class="page">
    ...
    <div class="fabu_page" style="padding-bottom:50px;">
      <div class="fabu_page_top">
        <p>
          <router-link :to="{ name: 'fabu'}">选择类型 ></router-link>出租民宿酒店信息
        </p>
      </div>
      ...
      <div class="yu_main">
          ...
          <ul class="yu_money">
              ...
              <li class="money">总计：<span>{{ Math.round( (money1 + money2 + money3 + money4 + money5 + money6)*100)/100 }}元</span></li>
    ...
    <div class="paymain" v-if='showdisplay'>
          <div class="paymain_box">
              <ul class="money">
                  <li class="num">￥{{ Math.round( (money1 + money2 + money3 + money4 + money5)*100)/100 }}</li>
...
export default {
  ...
  methods: {
    ...
    submitbtn(){
      ...
      form.append('mating',this.mating)
      ...
      this.$http("/app/rendInfoApi/saveHotel","post",form,this.$store.state.token).then(res => {
