        ...
        <div class="navlist">
            <div class="navlist_top">
                <div v-for="(item,key) in list" v-bind:key="key">
                    <ul v-if="item.valueField!=='zd_xinxi'&&item.valueField!=='zd_fenzhan'&&item.valueField!=='zd_mianji'&&item.valueField!=='zd_buy_bangong'">
                    ...
                    <ul v-if="item.valueField=='zd_mianji'">
                     ...
                     <ul v-if="item.valueField=='zd_buy_bangong'">
                        <li class="title">{{item.valueName}}</li>
