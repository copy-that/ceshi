        ...
        <div class="navlist">
            <div class="navlist_top">
                <div v-for="(item,key) in list" v-bind:key="key">
                    <ul v-if="item.valueField!=='zd_xinxi'&&item.valueField!=='zd_fenzhan'&&item.valueField!=='zd_buy_qifang'&&item.valueField!=='zd_mianji'">
                    ...
                    <ul v-if="item.valueField=='zd_buy_qifang'">
                        <li class="title">{{item.valueName}}</li>
                        <div style="float:left;width:1100px;">
